        ...
        <div class="card-body" style="text-align: center;">
            ...
            <?php if ($studentInfo): ?>
                <div style="margin-top: 1.5rem; padding: 1rem; background: #f8f9fa; border-radius: 8px; text-align: left;">
                    <h4 style="margin-bottom: 0.75rem; color: #667eea;">Student Info</h4>
                    <p style="margin: 0.25rem 0;"><strong>Student ID:</strong> <?= e($studentInfo['student_id']) ?></p>
                    <p style="margin: 0.25rem 0;"><strong>Department:</strong> <?= e($studentInfo['department']) ?></p>
                    <p style="margin: 0.25rem 0;"><strong>Year:</strong> <?= $studentInfo['year'] ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name" class="form-control" value="<?= e($userData['full_name']) ?>" required>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" class="form-control" value="<?= e($userData['phone']) ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control" rows="2"><?= e($userData['address']) ?></textarea>
                    </div>
